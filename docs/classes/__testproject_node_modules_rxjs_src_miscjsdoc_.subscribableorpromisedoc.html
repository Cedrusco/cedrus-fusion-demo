...
<head>
	...
	<title>SubscribableOrPromiseDoc | components-demo</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="__testproject_node_modules_rxjs_src_miscjsdoc_.subscribableorpromisedoc.html">SubscribableOrPromiseDoc</a>
				</li>
			</ul>
			<h1>Class SubscribableOrPromiseDoc&lt;T&gt;</h1>
		</div>
	</div>
</header>
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p><code>SubscribableOrPromise</code> interface describes values that behave like either
					...
					<p>RxJS <a href="../modules/__testproject_node_modules_rxjs_src_observable_ifobservable_.ifobservable.observable.html">Observable</a> instance.</p>
					...
					<dl class="tsd-comment-tags">
						<dt>example</dt>
						<dd><p><caption>Use merge and then map with non-RxJS observable</caption>
								const nonRxJSObservable = {
								subscribe(observer) {
								observer.next(1000);
								observer.complete();
								},
								<a href="">Symbol.observable</a> {
								return this;
								}
							};</p>
							<p>Rx.Observable.merge(nonRxJSObservable)
								.map(value =&gt; &quot;This value is &quot; + value)
							.subscribe(result =&gt; console.log(result)); // Logs &quot;This value is 1000&quot;</p>
						</dd>
						<dt>example</dt>
						<dd><p><caption>Use combineLatest with ES6 Promise</caption>
			...
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="target">SubscribableOrPromiseDoc</span>
					</li>
				</ul>
			</section>
		</div>
